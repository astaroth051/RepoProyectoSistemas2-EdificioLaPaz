...
export default function DashboardEdificio() {
  ...
  const [copropietarios] = useState<Copropietario[]>([ // Removed useName, used useState
    { id: 1, nombre: "Juan Armando", apellido: "Perez", departamento: "A-101", correo: "juan@example.com" },
    { id: 2, nombre: "María Eugenia", apellido: "Lopez", departamento: "B-203", correo: "maria@example.com" },
    { id: 3, nombre: "Carlos Fernando", apellido: "Sainz", departamento: "C-305", correo: "carlos@example.com" },
  ]);
